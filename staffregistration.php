...
$qua=explode(',',$Qualificationn);// USE INUPDATEPAGE TORETREIVE DATA AS SEPERATE SSLS,PG ETC
   ...
   0 mysqli_query($con,"INSERT INTO `login`( `Username`, `Password`,`type`) VALUES ('$Username','$Password', 'admin')");
}
